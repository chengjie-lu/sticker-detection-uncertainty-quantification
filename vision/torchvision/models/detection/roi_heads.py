...
class RoIHeads(nn.Module):
    ...
    def postprocess_detections(
        ...
        for boxes, scores, image_shape in zip(pred_boxes_list, pred_scores_list, image_shapes):
            ...
            logits = logits[(inds / (num_classes - 1)).int()]
    ...
    def forward(
        ...
        # print(
        #     '/home/complexse/workspace/RoboSapiens/DTI -
        #     Laptop refubishment/sticker_detector/vision/torchvision/models/detection/roi_heads.py')
