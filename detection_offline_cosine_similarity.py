        ...
        for box, label, score in zip(boxes, labels, scores):
            if self.show_bounding_box_sticker:
                if label == 'Sticker':
                    ...
                    # image_og = cv.rectangle(image_og, (int(box[1]), int(box[3])), (int(box[2]), int(box[0])),
                    #                         (255, 0, 0), 2)
    ...
    def predict_multi(self, image_rz, image_og, n=10):
        ...
        for key in predictions.keys():
            ...
            predictions[key].update({
                ...
                'predictive_surface': predictive_surface
            })
...
if __name__ == '__main__':
    ...
    detector.predict_multi(i_rz, i_og, n=20)
